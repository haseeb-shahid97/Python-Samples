...
class PeriodicTask(models.Model):
    ...
    # This will be used whenever we want to actually completely kill the task, will be used for the report scheduler
    ...
    # This will be converted used for the other scheduling, we want to get a time 
    expire_seconds = models.PositiveIntegerField(
        ...
        help_text=_(
            ...
            "trigger the task to run: 3600 == 1 hour, 14400 == 4 hours, 28800 == 8 hours, 57600 == 16 hours"
        ),
    )
